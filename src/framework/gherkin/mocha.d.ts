...
/* eslint-disable no-var,@typescript-eslint/no-empty-interface,@typescript-eslint/ban-types */
/* eslint-disable max-classes-per-file,@typescript-eslint/no-explicit-any */
// The above errors are ignored so that this imported types file does not spew errors in the build
